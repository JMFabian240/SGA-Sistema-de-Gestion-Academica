  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-300">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 bg-slate-50 p-4 rounded-xl mb-6 border border-slate-200">
          <div>
          ...
          <div>
            <label className="block text-sm text-slate-700 font-medium mb-1">Beca Asociada</label>
            ...
            <div key={v.ventanaId} className="flex flex-col sm:flex-row justify-between sm:items-center p-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors gap-4">
              <div>
                <p className="font-bold text-slate-800 flex items-center gap-2">
                  <Percent size={14} className="text-emerald-600" />
                  {v.beca ? `${v.beca.porcentaje}% de Descuento Asociado` : 'Sin beca asignada'}
                </p>
                <div className="flex gap-2 text-sm text-slate-600 font-medium mt-2 flex-wrap">
                  <span className="bg-slate-100 px-2 py-0.5 rounded-md">Ciclo: {v.ciclo?.nombre}</span>
                </div>
